...
import org.example.Others.Item;
...
public class InventoryController implements Initializable{
    ...
    /**
     * Reloads records from the database and updates the view.
     */
    ...
    /**
     * Sets up the view with initial data and event handlers.
     */
    ...
    /**
     * Navigates between items in the inventory.
     */
    private void recordNavigator() {
        ...
        if (onView.getPhoto() == null) {
            ImagePattern img = new ImagePattern(new Image("/icons/trolley.png"));
    ...
    /**
     * Handles switching between add mode and navigation mode.
     * @param event The action event that triggered the method.
     */
    @FXML
