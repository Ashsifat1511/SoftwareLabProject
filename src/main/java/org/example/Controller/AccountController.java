...
/**
 * This class controls the functionality of the Account.fxml file.
 * Designed by Swapnil
 */
public class AccountController implements Initializable {
    ...
    /**
     * Initializes the account creation form by setting default values and retrieving the highest account ID.
     */
    ...
    /**
     * Reloads all accounts associated with the currently logged-in user.
     */
    @FXML
    ...
    /**
     * Handles the action when the add button is clicked to create a new account.
     */
    @FXML
    void btnAddAction(ActionEvent event) {
        ...
        if(!flag){
            ...
            //final JFXSnackbar.SnackbarEvent snackbarEvent =new JFXSnackbar.SnackbarEvent(new Label("Field Required!!"),Duration.millis(3000),null);
