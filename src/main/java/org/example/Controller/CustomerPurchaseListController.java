/**
 * Controller class for managing the list of purchases made by a customer in a JavaFX application.
 */
...
/**
 * Controller class to handle the display of a customer's purchase history.
 * Designed by Tithi
 */
