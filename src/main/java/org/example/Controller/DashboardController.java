...
public class DashboardController implements Initializable{
    ...
    /**
     * Sets the initial values for the fields on the dashboard.
     */
     ...
     *
     * @param event The action event triggering the reload.
     */
    @FXML
    ...
    /**
     * Opens the rental list view.
     *
     * @param event The action event triggering the opening of the rental list.
     */
    @FXML
    void showRent(ActionEvent event) {
        try {
            RentalListController.todayFlag = true;
            Parent rentList = FXMLLoader.load(getClass().getResource("/view/rentallist.fxml"));
    ...
    /**
     * Opens the sell list view.
     *
     * @param event The action event triggering the opening of the sell list.
     */
    @FXML
    void showSell(ActionEvent event) {
        try {
            SellListController.todayFlag = true;
            Parent sellsList = FXMLLoader.load(getClass().getResource("/view/selllist.fxml"));
