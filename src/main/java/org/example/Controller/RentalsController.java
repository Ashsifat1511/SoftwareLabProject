...
/**
 * Controller class for managing rental  UI.
 * Designed by Tithi
 */
...
public class RentalsController implements Initializable {
    ...
    /**
     * Refreshes the UI to default state.
    ...
    /**
     * Proceeds with the rental process or verifies input.
     * @param event The action event.
     */
    @FXML
        ...
        if (startTransaction) {
            ...
            try {
                ...
                if(chk <= 0) {
                    ...
                    Parent trPanel = FXMLLoader.load(getClass().getResource("/view/transaction.fxml"));
                ...
                //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Invalid Input Format!"), Duration.millis(3000), null);
            ...
            try {
                ...
                if (customerID.indexOf(Integer.valueOf(txtCustomerId.getText())) == -1) {
                    ...
                    //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Invalid Customer ID"), Duration.millis(3000), null);
                    //snackbar.enqueue(snackbarEvent);
                }
            } catch (Exception e) {
                flag = false;
                try {
                    ...
                    //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Invalid Input"), Duration.millis(3000), null);
                    //snackbar.enqueue(snackbarEvent);
                }
            }
            ...
            try {
                ...
                if (itemIDForRent.indexOf(Integer.valueOf(txtItemId.getText())) == -1) {
                    ...
                    //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Item ID is not listed"), Duration.millis(3000), null);
                    //snackbar.enqueue(snackbarEvent);
                }
            } catch (Exception e) {
                flag = false;
            ...
            if(txtReturnDate.getValue() == null) {
                ...
                //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Return Date Required"), Duration.millis(3000), null);
                // snackbar.enqueue(snackbarEvent);
            } else {
                ...
                if(days < 0) {
                    ...
                    //final JFXSnackbar.SnackbarEvent snackbarEvent = new JFXSnackbar.SnackbarEvent(new Label("Return Date can not be earlier than Rental Date!"), Duration.millis(3000), null);
                    //snackbar.enqueue(snackbarEvent);
    ...
    /**
     * Generates a line chart or toggles back to table view.
     */
